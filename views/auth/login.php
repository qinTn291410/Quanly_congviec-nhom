...
<head>
    <meta charset="UTF-8">
    <title>Đăng nhập - Workspace</title>
    <style>
        ...
        .auth-links a, .forgot-link { color: #2383e2; text-decoration: none; font-weight: 500; }
...
<body>
    <div class="auth-container">
        ...
        <p class="auth-subtitle">Chào mừng quay trở lại Workspace!</p>
        ...
        <form action="index.php?action=login" method="POST">
            ...
            <div style="text-align: right; margin-top: -5px; margin-bottom: 15px;">
                <a href="index.php?action=forgot-password" class="forgot-link" style="font-size: 0.85rem;">Quên mật khẩu?</a>
            </div>
