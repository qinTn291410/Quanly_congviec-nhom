    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 20px;">
        ...
        <?php else: ?>
            <?php foreach($projects as $p): ?>
                <div style="border: 1px solid #e3e2e0; border-radius: 8px; padding: 20px; transition: 0.2s;">
                    <h3 style="margin: 0 0 10px 0; color: #37352f; font-size: 1.1rem;"><?= htmlspecialchars($p['name']) ?></h3>
